...
int main()
{
	...
	*/
	...
	camera = Camera(glm::vec3(0.0f, 0.0f, -5.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.3f, 0.3f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = modelBase;
		//-0.78f
		model = glm::translate(model, glm::vec3(0.0f, -0.752f, -0.55f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.0f, 0.4444f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		...
		//t2 azul
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.25f, -0.752f, -0.12f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.0f, 0.4444f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//t3 azul
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -0.752f, -0.26f));
		model = glm::scale(model, glm::vec3(0.4555f, 0.0f, 0.4555f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		...
		//t5 azul
		model = modelBase;
		model = glm::translate(model, glm::vec3(-0.48f, -0.752f, 0.28f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.0f, 0.4444f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//T7 azul
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.24f, -0.752f, 0.15f));
		model = glm::scale(model, glm::vec3(0.4333f, 0.0f, 0.4333f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//t9 azul
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -0.752f, 0.28f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.0f, 0.4444f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//-0.78f
		//0.25f
		model = glm::translate(model, glm::vec3(0.0f, 0.43f, 0.04f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.4444f, 0.4111f));
	    model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		...
		//t2 verde
		model = modelBase;
		model = glm::translate(model, glm::vec3(-0.25f, -0.08f, 0.21f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.4444f, 0.4111f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
		//model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1, 0, 0));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		...
		//T4 verde
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -0.08f, 0.21f));
		model = glm::scale(model, glm::vec3(0.4444f, 0.4444f, 0.4111f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0, 1, 0));
