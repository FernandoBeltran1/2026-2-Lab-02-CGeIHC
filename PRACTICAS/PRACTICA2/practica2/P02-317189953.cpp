...
void CreateShaders()
{
	...
	shader6->CreateFromFiles(vShaderverde, fShader);
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 2.2f, -6.0f));
		model = glm::scale(model, glm::vec3(3.5f, 2.0f, 0.15f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.7f, 0.5f, -7.9f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.975f, -7.9f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 3.0f));
		...
		//tronco izquierdo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-3.0f, -1.35f, -7.9f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-3.0f, 0.29f, -7.7f));
		model = glm::scale(model, glm::vec3(2.0f, 2.5f, 0.8f));
